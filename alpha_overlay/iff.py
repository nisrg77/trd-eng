...
def apply_iff_gate(
    ...
    # Opposing: ML says BUY (s_composite > 0) but flow is bearish (flow_score < -veto_threshold),
    # or ML says SELL (s_composite < 0) but flow is bullish (flow_score > veto_threshold)
